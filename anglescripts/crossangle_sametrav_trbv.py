# -*- coding: utf-8 -*-
"""
Name: crossangle_sametrav_trbv.py
Function: Plots the crossing angle for every TRAV-TRBV combination in the dataset
Date: 6-11-2024
...
def main():
    ...
    matplotlib_output = '../plots/crossangle_sametravtrbv.png'
    bokeh_output = '../plots/crossanglesametravtrbvbokeh.html'
    ...
    unique_pairs = data['TRAV_TRBV'].unique()

    # Generate colors
    colors = generate_distinct_colors(len(unique_pairs))

    # Create matplotlib scatter plot
    scatter_plot_matplotlib(data, unique_pairs, colors, matplotlib_output)

    # Create bokeh scatter plot
    scatter_plot_bokeh(data, unique_pairs, colors, bokeh_output)
