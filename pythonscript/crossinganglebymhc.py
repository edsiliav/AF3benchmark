# -*- coding: utf-8 -*-
"""
Name: crossanglebymhc.py
Function: Plots the crossing angle by MHC excluding cases with reverse docking
Date: 29-10-2024
...
def main():
    ...
    output_file = '../plots/crossinganglebymhc2.png'
