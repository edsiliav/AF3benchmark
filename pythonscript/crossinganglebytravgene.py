# -*- coding: utf-8 -*-
"""
Name: crossanglebytravgene.py
Function: Plots the crossing angle by TRAV gene excluding cases with reverse docking
Date: 29-10-2024
...
def main():
    ...
    output_file = '../plots/crossinganglebytravgene2.png'
...
def plot_crossing_angles(df, output_file):
    ...
    plt.title('Crossing Angles by TRAV Gene')
